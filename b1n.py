...
[By Dreifus] [v3.0] [Leia o README.md]""")

print("[1]: Converter Numero Normal em Binário")
print("[2]: Converter bite Em Byte")
print("[3]: Converter Byte Em bite")
pc1=int(input("> "))
...
if(pc1==3):
   ...
   n5=int(input("> "))
   n6=n5*8
   print("[+]: Isso é mais ou menos {} bits".format(n6))
